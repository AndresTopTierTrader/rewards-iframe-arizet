  ...
  return (
    ...
    >
      ...
      <div className="userProfile__body">
        ...
        >
          <HiEnvelope style={{ fontSize: '18px', color: 'var(--textSecondary)', flexShrink: 0 }} />
        ...
        <motion.div 
          ...
          transition={{ type: "spring", stiffness: 300 }}
        >
          <HiCalendar style={{ fontSize: '18px', color: 'var(--textSecondary)', flexShrink: 0 }} />
          <div className="userProfile__itemContent">
